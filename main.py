...
# criado por Fernando Rui Campos 13 Fevereiro a 4 de março 2023. Testes realizados com mais de 2000 imagens de diversas resoluções de
...
print(f"caminho encontrado onde se encontra o ficheiro de configuracao :  {config_file}")
...
if numero_itens < 0:
    print(
        f"O numero de imagens existentes para processamento na pasta de origem {pasta_imagem} e inferior a 1. A sair...")
    exit(2)

if num_files_max > numero_itens + 1:
    num_files_max = numero_itens + 1
    print(
        f"O numero de imagens para processamento programado na variável num_files_max  {num_files_max} e inferior ao existente na pasta de origem {pasta_imagem}. A ajustar numero de ficheiros a processar ")
i = 0
